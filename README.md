...
قالب مستقل نگارش پایان‌نامه کارشناسی ارشد و رساله دکتری دانشکده علوم ریاضی دانشگاه تربیت مدرس، با پشتیبانی از فارسی، فرمول‌های ریاضی، قضیه و اثبات، الگوریتم، کد منبع، جدول، شکل، واژه‌نامه، نمایه و دو شیوه مدیریت منابع.
...
- دستگاه معادلات، بردار و ماتریس، الگوریتم شبه‌کد و قطعه‌کد Python؛
- جدول‌های حرفه‌ای و چندصفحه‌ای، زیرشکل، صفحه افقی، پیوست، واژه‌نامه و نمایه؛
- فایل Word چهارصفحه‌ای مستقل برای تحویل پایان‌نامه‌های ریاضی؛
...
ترتیب صفحات، تنظیم چکیده و فهرست، درج PDF تأیید استادان، تاریخ دفاع و فایل Word چهارصفحه‌ای در [راهنمای انطباق با شیوه‌نامه دانشگاه](docs/official-format-1403.md) ثبت شده است.
