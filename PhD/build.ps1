...
$mainFile = 'PhD_Thesis_TMU.tex'
$logFile = 'PhD_Thesis_TMU.log'
$biberLogFile = 'PhD_Thesis_TMU.blg'
$consoleLogFile = Join-Path $PSScriptRoot 'PhD_Thesis_TMU.build-output.txt'
