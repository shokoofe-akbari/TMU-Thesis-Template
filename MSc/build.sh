...
MAIN_FILE='Mas_Thesis_TMU.tex'
LOG_FILE='Mas_Thesis_TMU.log'
BIBER_LOG_FILE='Mas_Thesis_TMU.blg'
CONSOLE_LOG="${SCRIPT_DIR}/Mas_Thesis_TMU.build-output.txt"
...
if ! latexmk -f -pdfxe -g -jobname=%A -interaction=nonstopmode -halt-on-error -file-line-error "${MAIN_FILE}" 2>&1 | tee "${CONSOLE_LOG}"; then
