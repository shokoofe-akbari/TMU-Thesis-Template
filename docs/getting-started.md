...
## ۷. تحویل ویژه رشته‌های ریاضی

همراه PDF کامل، فایل Word چهارصفحه‌ای پوشه `Submission` تکمیل می‌شود و پوشه کامل منبع LaTeX نیز به‌صورت ZIP آماده می‌گردد. ترتیب صفحات و کنترل‌های نهایی در [راهنمای انطباق با شیوه‌نامه دانشگاه](official-format-1403.md) آمده است.
